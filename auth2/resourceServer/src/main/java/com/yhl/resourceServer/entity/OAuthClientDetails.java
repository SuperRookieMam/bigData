...
public class OAuthClientDetails extends BaseEntity {
    ...
    @CollectionTable(name = "resource_server_client", joinColumns = {
    ...
    public static OAuthClientDetailsDto toOAuthClientDetailsDto(OAuthClientDetails model) {
        ...
        Set<OAthGrantedAuthorityDto> set =OAthGrantedAuthority.tooAthGrantedAuthorityDto(model.getAuthorities());
        List list =Collections.emptyList();
        list.add(set);
        dto.setAuthorities(list);
